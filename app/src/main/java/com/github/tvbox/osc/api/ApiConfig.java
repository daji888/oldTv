...
//                System.out.println("urlLive :"+url);
 ...
 //               liveChannelGroupList.add(liveChannelGroup);
  ...
  //                          url = Base64.encodeToString(url.getBytes("UTF-8"), Base64.DEFAULT | Base64.URL_SAFE | Base64.NO_WRAP);
        ...
        String defaultEXO = "{\"exo\":[{\"options\":[{\"name\":\"DefaultRenderersFactory\",\"value\":\"setExtensionRendererMode(EXTENSION_RENDERER_MODE_ON)\"}],\"group\":\"硬解\"},{\"options\":[{\"name\":\"DefaultRenderersFactory\",\"value\":\"setExtensionRendererMode(EXTENSION_RENDERER_MODE_PREFER)\"}],\"group\":\"软解\"}]}";
