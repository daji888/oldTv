...
public class ApiConfig {
    ...
    private void parseJson(String apiUrl, String jsonStr) {
        ...
        String defaultEXO = "{\"exo\":[{\"options\":[{\"extensionRendererMode\":\"DefaultRenderersFactory.EXTENSION_RENDERER_MODE_OFF\"}],\"group\":\"硬解\"},{\"options\":[{\"extensionRendererMode\":\"DefaultRenderersFactory.EXTENSION_RENDERER_MODE_ON\"}],\"group\":\"硬软\"},{\"options\":[{\"extensionRendererMode\":\"DefaultRenderersFactory.EXTENSION_RENDERER_MODE_PREFER\"}],\"group\":\"软硬\"}]}";
