...
//                System.out.println("urlLive :"+url);
 ...
 //               liveChannelGroupList.add(liveChannelGroup);
  ...
  //                          url = Base64.encodeToString(url.getBytes("UTF-8"), Base64.DEFAULT | Base64.URL_SAFE | Base64.NO_WRAP);
        ...
        String defaultEXO = "{\"exo\":[{\"options\":[{\"name\":\"EXTENSION_RENDERER_MODE_OFF\",\"category\":0,\"value\":\"0\"}],\"group\":\"硬解\"},{\"options\":[{\"name\":\"EXTENSION_RENDERER_MODE_ON\",\"category\":1,\"value\":\"1\"}],\"group\":\"硬软\"},{\"options\":[{\"name\":\"EXTENSION_RENDERER_MODE_PREFER\",\"category\":2,\"value\":\"2\"}],\"group\":\"软硬\"}]}";
