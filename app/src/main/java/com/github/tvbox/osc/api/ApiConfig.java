...
public class ApiConfig {
    ...
    private void parseJson(String apiUrl, String jsonStr) {
        ...
        String defaultEXO = "{\"exo\":[{\"options\":[{\"extensionRendererMode\":\"DefaultRenderersFactory.EXTENSION_RENDERER_MODE_OFF\",\"value\":\"0\"}],\"group\":\"硬解\"},{\"options\":[{\"extensionRendererMode\":\"DefaultRenderersFactory.EXTENSION_RENDERER_MODE_ON\",\"value\":\"1\"}],\"group\":\"硬软\"},{\"options\":[{\"extensionRendererMode\":\"DefaultRenderersFactory.EXTENSION_RENDERER_MODE_PREFER\",\"value\":\"2\"}],\"group\":\"软硬\"}]}";
