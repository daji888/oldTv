...
public class HomeActivity extends BaseActivity {
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            SimpleDateFormat timeFormat = new SimpleDateFormat("yy/M/d  EE  H:mm:ss");
    ...
    private void initView() {
        ...
        this.sortAdapter.setOnItemLongClickListener(new BaseQuickAdapter.OnItemLongClickListener() {
            @Override
    ...
    private void initData() {
        ...
        if (dataInitOk && jarInitOk) {
            ...
            if (!useCacheConfig) warmSearchSpidersOnce(); // 爬虫预热 仅首次加载
            return;
        }
        showLoading();
        if (dataInitOk && !jarInitOk) {
