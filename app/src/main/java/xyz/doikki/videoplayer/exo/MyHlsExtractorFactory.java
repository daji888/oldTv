...
import xyz.doikki.videoplayer.exo.BundledHlsMediaChunkExtractor;
...
public final class MyHlsExtractorFactory implements HlsExtractorFactory {
  ...
  @Override
  public MyHlsExtractorFactory setSubtitleParserFactory(
  ...
  @CanIgnoreReturnValue
  @Override
  public MyHlsExtractorFactory experimentalParseSubtitlesDuringExtraction(
